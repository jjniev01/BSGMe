...
bsgm.census.data.fln.Rdata <- paste0("population_data_",bsgm.countries.tag,
                                     ".Rdata")
bsgm.census.data.fln.csv<- paste0("population_data_",bsgm.countries.tag, ".csv")
bsgm.covariates.RF.Rdata <- paste0("covariates_RF_",bsgm.countries.tag, 
                                   ".Rdata")
...
bsgm.bsgmfit.final.RData <- paste0("bsgmfit_final_",bsgm.countries.tag,
                                   ".Rdata")
bsgm.bsgmfit.quant.RData <- paste0("bsgmfit_quant_",bsgm.countries.tag,
                                   ".Rdata")
...
bsgm.rst.bsgm.census.tif <- paste0("pop_census_mask_",
                                   bsgm.countries.tag, ".tif")

bsgm.forec.table <- paste0("forecast_table_",bsgm.countries.tag,"_unadjusted.RDS")
bsgm.forec.table.inla.limited <- paste0("forecast_table_inla_limited_",
                                     bsgm.countries.tag,".RDS")
